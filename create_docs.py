...
table_data = [
    ...
    ['Privacy & PII Protection', 'Regex Privacy Shield Engine', 'client/src/components/PrivacyShield.jsx, server/controllers/complaintController.js', 'Automatically detects and redacts Aadhaar numbers, phone numbers, and sensitive PII before database storage.', 'DPDP Act Compliance & Data Anonymization'],
